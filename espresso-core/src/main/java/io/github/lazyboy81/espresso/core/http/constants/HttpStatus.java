...
public enum HttpStatus {
    ...
    MISDIRECTED_REQUEST(421, HttpStatus.Series.CLIENT_ERROR, "Misdirected Request"),
    UNPROCESSABLE_CONTENT(422, HttpStatus.Series.CLIENT_ERROR, "Unprocessable Content"),
